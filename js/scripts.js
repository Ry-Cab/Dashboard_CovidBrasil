...
_elements.selectOptions.forEach(item => {
    item.addEventListener("click", () => {
        ...
        _elements.stateSelectToggle.dispatchEvent(new Event("click")); //Simulando um evento de clique sem a interação do usuário
...
const request = async (api, id) => {
    ...
    const data = await fetch(url); // await --> Fazer o JS esperar a promisse do Fetch
